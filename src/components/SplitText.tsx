  ...
  useGSAP(
    () => {
      ...
      const assignTargets = (self: any) => {
        if ((splitType as string).includes('chars') && self.chars.length) targets = self.chars;
        if (!targets && (splitType as string).includes('words') && self.words.length) targets = self.words;
        if (!targets && (splitType as string).includes('lines') && self.lines.length) targets = self.lines;
        ...
        onSplit: (self: any) => {
          ...
          return gsap.fromTo(
            ...
            { ...from },
            {
              ...
              onComplete: () => {
                (animationCompletedRef as any).current = true;
                onLetterAnimationComplete?.();
              },
