...
const cardData: Array<{ color: string; title: string; description: string; label: string }> = [
    ...
    <>
      <style>{`
          ...
          .card--border-glow::after {
            content: '';
            position: absolute; inset: 0; padding: 6px; border-radius: inherit; pointer-events: none; transition: opacity 0.3s ease; z-index: 1;
            ...
            mask: linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0); mask-composite: subtract; -webkit-mask: linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0); -webkit-mask-composite: xor;
          }
